    ...
    $.getJSON(widgetAPI, function(data) {
        ...
        for (var i in widgets) {
            ...
            var newItem = '<!-- START WIDGET ITEM --> \
                <div class="widget-item '+ ['category-',category].join('') + ' b-a b-grey" data-width="1" data-height="1" \
                        ...
                        <div class="overlayer-wrapper item-info"> \
                            <div class="p-l-20 p-r-20 p-t-20 p-b-5"> \
                                <div class="item-footer"> \
                                    <p class="pull-left fs-11 font-montserrat all-caps">' + widget['title'] + '</p> \
                                    <p class="pull-right semi-bold"> \
                                        <span class="fa-stack"> \
