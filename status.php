    ...
    <div class="main-content-wrapper d-flex clearfix">
      ...
      <!-- START CONTAINER FLUID -->
        ...
        <div id="Sell" class="tabcontent">
          <button class="tabsell" onclick="openPageSell('NotYetPaidSell', this, '#3e3e3e')" id="defaultOpenSell">Belum Bayar</button>
          <button class="tabsell" onclick="openPageSell('NeedSent', this, '#3e3e3e')">Perlu Dikirim</button>
          <button class="tabsell" onclick="openPageSell('SentSell', this, '#3e3e3e')">Dikirim</button>
          <button class="tabsell" onclick="openPageSell('FinishedSell', this, '#3e3e3e')">Selesai</button>
          <button class="tabsell" onclick="openPageSell('Canceled', this, '#3e3e3e')">Dibatalkan</button>
          <button class="tabsell" onclick="openPageSell('Returned', this, '#3e3e3e')">Pengembalian</button>
          <div id="NotYetPaidSell" class="tabcontentsell">
            <div class="container-fluid container-fixed-lg" style="padding-top:80px; padding-left:40%;">
              <img src="img/core-img/no-order.png" height="150px" width="200px">
              <p style="color:black; padding-left:5%">There are no orders</p>
            </div>
          </div>
